...
const experiences: ExperienceItem[] = [
        ...
        projects: [
            {
                ...
                description: "",
                bullets: [
                    "Engineered a multi-stage matching pipeline generating 7M+ matches for 20k+ entities.",
                    "Reduced matching complexity from O(n²) using Locality Sensitive Hashing, pruning millions of comparisons into a tractable candidate set.",
                    "Eliminated memory bottlenecks by offloading large graph state to off-heap storage, keeping heap usage stable under scale.",
                    "Designed a fault-tolerant ingestion layer using Kafka with custom backpressure and retries, and implemented a Top-K refinement stage optimized for memory and latency constraints."
                ],
            ...
            },
            {
                ...
                bullets: [
                    ...
                    "Implemented a progressive profiling workflow for multi-persona user journeys and personalized media feeds, achieving 40% latency reduction via caching.",
                    "Designed an event-driven architecture for profile synchronization, match delivery, and real-time chat messaging, using retries, rate limiting, fraud prevention, and the Outbox Pattern to ensure reliable, at-least-once message delivery under load."
                ],
    ...
    },
    {
        ...
        bullets: [
            "Built and evolved standards-compliant financial APIs aligned with RBI Account Aggregator and FCC Sanctions Screening specifications, contributing to 20% faster feature delivery by enabling product teams to iterate safely within sprint-based workflows.",
            "Owned backend improvements across FIU APIs and sanctions screening pipelines, driving 15–25% performance gains through profiling, validation, and iterative optimization of components.",
            "Worked closely with QA, DevOps, and dependent teams to define API contracts, error handling, and validation rules, reducing release friction and improving production stability.",
            "Documented requirements, technical decisions, and system tradeoffs in tickets and lightweight design notes, supporting predictable delivery under evolving regulatory constraints.",
            "Provided technical mentorship to interns across projects, focusing on backend design principles, code quality, and production readiness."
        ],
